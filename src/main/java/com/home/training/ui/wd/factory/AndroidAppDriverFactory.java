...
public class AndroidAppDriverFactory implements DriverFactory {
    ...
    public WebDriver getWebDriver() {
        ...
        capabilities.setCapability(DriverConstants.CAP_APP_PACKAGE, "com.android.chrome");
        capabilities.setCapability(DriverConstants.CAP_APP_ACTIVITY, "com.google.android.apps.chrome.Main");
        capabilities.setCapability(DriverConstants.CAP_UNICODE, true);
        capabilities.setCapability(DriverConstants.CAP_RESET_KEYBOARD, true);
        capabilities.setCapability(DriverConstants.CAP_NO_RESET, true);
